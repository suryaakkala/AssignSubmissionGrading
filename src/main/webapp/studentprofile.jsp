...
<div class="container" style="display: flex; justify-content: center; align-items: center; height: 100vh;">
  <div class="card">
    ...
    <div class="bottom">
      <div class="content">
        <p class="name"><strong>ID:</strong> <%= s != null ? s.getId() : "Not available" %></p>
        <p class="name"><strong>Name:</strong> <%= s != null ? s.getName() : "Not available" %></p>
        <p class="name"><strong>Gender:</strong> <%= s != null ? s.getGender() : "Not available" %></p>
        <p class="name"><strong>Email:</strong> <%= s != null ? s.getEmail() : "Not available" %></p>
      </div>
      <!-- Button Example -->
      <div class="bottom-bottom">
        <a href="updatestudentprofile" class="button" >Edit</a>>&nbsp;&nbsp;
