...
<h1 class="hea"> ONLINE ASSIGNMENT SUBMISSION </h1>
    ...
    <main class="form-signin">
        ...
        <h4 align="center" style="color:red">
            ...
            <div class="form-floating">
                <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com" name="semail" required>
                <label for="floatingInput">Email address</label>
            </div>

            <!-- Password Input -->
            <div class="form-floating">
                <input type="password" class="form-control" id="floatingPassword" placeholder="Password" name="spwd" required>
            ...
            <div class="mt-4 text-center">
                <h5>Or</h5>
                <p>
                    <a href="facultylogin" class="bonf" style="vertical-align:middle"> 	<span>Faculty</span> </a>
                    <a href="studentreg" class="bon" style="vertical-align:middle">	<span>Student</span> </a>
                </p>
            </div>
    ...
    <!-- Optional: Include Bootstrap JS for modal and other components -->
